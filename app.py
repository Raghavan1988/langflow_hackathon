...
input_text = st.text_area("Enter the question or describe for image generation (Use any low-resource language):","پس منظر میں ایک لڑکا ٹرین کے ساتھ بارش میں کھیل رہا ہے۔")
